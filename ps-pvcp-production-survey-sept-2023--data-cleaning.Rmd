...
About 26% of the registered farmers was targeted as sample size for the survey corresponding to 6,358 participants. Stratified Sampling was used to determine the sample size for each Local Government since the number of registered farmers vary across the LGAs. At the end of the survey, 4,747 farmers participated being 19.6% of the total registered farmers and 74% of the target sample size. The survey data (in csv format) is stored in GitHub, an open source developer platform and can be accessed via [this link](https://github.com/spomaria/ps_pvcp_survey_report_jul_2023).
...
This concludes the data cleaning exercise for this survey.
